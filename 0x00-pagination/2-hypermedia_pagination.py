...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """Function that takes two integer arguments page and page_size, uses
        index_range to find the correct indexes to paginate the
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> dict:
        """
        Returns a dictionary containing page information
        """
